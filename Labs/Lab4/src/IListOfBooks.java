...
public interface IListOfBooks {
  ...
  /**
   * Create and return a string that can be used to print this list Since toString is inherited from
   * Object, this is merely a reminder to provide a more useful version in your implementation.
   *
